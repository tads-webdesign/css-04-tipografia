# Tutorial CSS 3 - Tipografia para Iniciantes
...
A tipografia é um dos aspectos mais importantes do design web. Ela afeta diretamente a legibilidade, a acessibilidade e a estética do seu site. CSS 3 oferece diversas propriedades para controlar a aparência do texto, permitindo criar experiências visuais atraentes e funcionais.
...
A propriedade `font-family` define a família de fontes que será usada para exibir o texto. É recomendado especificar múltiplas fontes como "fallback" (alternativas).
...
A propriedade `font-size` define o tamanho da fonte. Pode ser especificada em várias unidades.
